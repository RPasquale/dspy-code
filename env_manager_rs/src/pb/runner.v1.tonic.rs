...
pub mod stream_supervisor_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("runner.v1.StreamSupervisor", "OpenStream"));
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/runner.v1.StreamSupervisor/OpenStream" => {
                    #[allow(non_camel_case_types)]
                    struct OpenStreamSvc<T: StreamSupervisor>(pub Arc<T>);
                    impl<
                        T: StreamSupervisor,
                    ...
                    for OpenStreamSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StreamSupervisor>::open_stream(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
