...
const file_env_manager_v1_proto_rawDesc = "" +
	...
	"\n" +
	"PullImages\x12!.env_manager.v1.PullImagesRequest\x1a!.env_manager.v1.ImagePullProgress0\x01B\xb1\x01\n" +
...
var file_env_manager_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_env_manager_v1_proto_goTypes = []any{
	...
	nil,                                    // 20: env_manager.v1.StartServicesRequest.OverridesEntry
	nil,                                    // 21: env_manager.v1.StopServicesResponse.ServiceResultsEntry
	nil,                                    // 22: env_manager.v1.ServicesStatusResponse.ServicesEntry
	nil,                                    // 23: env_manager.v1.ServiceStatus.HealthChecksEntry
	nil,                                    // 24: env_manager.v1.HealthUpdate.DetailsEntry
	nil,                                    // 25: env_manager.v1.ExecuteTaskRequest.PayloadEntry
	nil,                                    // 26: env_manager.v1.ExecuteTaskResponse.ResultEntry
}
var file_env_manager_v1_proto_depIdxs = []int32{
	20, // 0: env_manager.v1.StartServicesRequest.overrides:type_name -> env_manager.v1.StartServicesRequest.OverridesEntry
	21, // 1: env_manager.v1.StopServicesResponse.service_results:type_name -> env_manager.v1.StopServicesResponse.ServiceResultsEntry
	22, // 2: env_manager.v1.ServicesStatusResponse.services:type_name -> env_manager.v1.ServicesStatusResponse.ServicesEntry
	23, // 3: env_manager.v1.ServiceStatus.health_checks:type_name -> env_manager.v1.ServiceStatus.HealthChecksEntry
	9,  // 4: env_manager.v1.ServiceStatus.resource_usage:type_name -> env_manager.v1.ResourceUsage
	24, // 5: env_manager.v1.HealthUpdate.details:type_name -> env_manager.v1.HealthUpdate.DetailsEntry
	...
	25, // 8: env_manager.v1.ExecuteTaskRequest.payload:type_name -> env_manager.v1.ExecuteTaskRequest.PayloadEntry
	26, // 9: env_manager.v1.ExecuteTaskResponse.result:type_name -> env_manager.v1.ExecuteTaskResponse.ResultEntry
	...
	1,  // 19: env_manager.v1.EnvManagerService.StartServices:output_type -> env_manager.v1.ServiceStatusUpdate
	3,  // 20: env_manager.v1.EnvManagerService.StopServices:output_type -> env_manager.v1.StopServicesResponse
	5,  // 21: env_manager.v1.EnvManagerService.RestartService:output_type -> env_manager.v1.RestartServiceResponse
	7,  // 22: env_manager.v1.EnvManagerService.GetServicesStatus:output_type -> env_manager.v1.ServicesStatusResponse
	11, // 23: env_manager.v1.EnvManagerService.StreamHealth:output_type -> env_manager.v1.HealthUpdate
	13, // 24: env_manager.v1.EnvManagerService.GetResourceAvailability:output_type -> env_manager.v1.ResourceAvailabilityResponse
	17, // 25: env_manager.v1.EnvManagerService.ExecuteTask:output_type -> env_manager.v1.ExecuteTaskResponse
	19, // 26: env_manager.v1.EnvManagerService.PullImages:output_type -> env_manager.v1.ImagePullProgress
