...
func (x *HealthRequest) Reset() {
	*x = HealthRequest{}
	mi := &file_orchestrator_v1_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthRequest) Descriptor() ([]byte, []int) {
	return file_orchestrator_v1_proto_rawDescGZIP(), []int{16}
}
...
func (x *HealthResponse) Reset() {
	*x = HealthResponse{}
	mi := &file_orchestrator_v1_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthResponse) Descriptor() ([]byte, []int) {
	return file_orchestrator_v1_proto_rawDescGZIP(), []int{17}
}
...
var file_orchestrator_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
