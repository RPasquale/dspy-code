...
func (x *SupervisorToWorker) Reset() {
	*x = SupervisorToWorker{}
	mi := &file_proto_runner_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SupervisorToWorker) Descriptor() ([]byte, []int) {
	return file_proto_runner_proto_rawDescGZIP(), []int{14}
}
...
const file_proto_runner_proto_rawDesc = "" +
	"\n" +
	"\x12proto/runner.proto\x12\trunner.v1\"\x8d\x01\n" +
	"\rResourceHints\x12%\n" +
	...
	"\n" +
	"OpenStream\x12\x1d.runner.v1.WorkerToSupervisor\x1a\x1d.runner.v1.SupervisorToWorker(\x010\x01B-Z+github.com/dspy/orchestrator/internal/pb;pbb\x06proto3"
...
var file_proto_runner_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
